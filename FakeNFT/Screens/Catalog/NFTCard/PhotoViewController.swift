...
class PhotoViewController: UIViewController {
    ...
    private var originalCloseButtonFrame: CGRect = .zero
    private var originalPageControlFrame: CGRect = .zero
...
extension PhotoViewController: UIScrollViewDelegate {
    ...
    func scrollViewDidZoom(_ scrollView: UIScrollView) {
        ...
        originalPageControlFrame = pageControl.frame
        ...
        if scrollView.zoomScale > 1.0 {
            ...
            closeButton.frame = originalCloseButtonFrame
            pageControl.frame = originalPageControlFrame
